export default {
  ...
  affiliate: {
    ...
    stats: {
      ...
      totalQuota: '历史返利额度',
      rebateRate: '当前返利比例',
      customRate: '已使用专属返利比例',
      globalRate: '当前跟随全局比例：{rate}%'
    },
    transfer: {
      title: '返利额度转余额',
  ...
  admin: {
    ...
    users: {
      ...
      form: {
        ...
        affiliateRebateRate: '专属返利比例',
        affiliateRebateRatePlaceholder: '留空则跟随全局返利比例',
        affiliateRebateRateHint: '仅对该用户生效，填写 0-100 表示单独覆盖；留空则恢复使用全局返利比例',
        affiliateRebateRateInvalid: '返利比例必须在 0 到 100 之间'
      },
      adjustBalance: '调整余额',
      ...
      features: {
        ...
        affiliate: {
          ...
          modal: {
            ...
            editTitle: '编辑专属配置',
            userLabel: '用户',
            userPlaceholder: '搜索邮箱、用户名或 ID',
            selectedUser: '已选择：{email}',
            codeLabel: '专属邀请码（可选）',
            codePlaceholder: '例如 VIP2026',
            codeHintAdd: '4-32 位，仅支持大写字母、数字、下划线、连字符；留空则沿用该用户当前邀请码；输入将自动转大写。',
            codeHintEdit: '4-32 位，仅支持大写字母、数字、下划线、连字符；留空表示不修改；输入将自动转大写。',
            rateLabel: '专属返利比例（可选）',
            ratePlaceholder: '例如 30',
            rateHintAdd: '0-100%；留空则沿用全局返利比例。',
            rateHintEditWithCustom: '0-100%；留空将清除此用户的专属比例，并恢复沿用全局返利比例。',
            rateHintEditWithGlobal: '0-100%；当前该用户正在沿用全局比例，留空则保持不变。',
            errorNoUser: '请先选择用户',
